...
private:
    std::unique_ptr<SyncQueueByte> input_queue_ = std::make_unique<SyncQueueByte>(1024 * 1024);
    std::unique_ptr<SyncQueueByte> output_queue_ = std::make_unique<SyncQueueByte>(1024 * 1024);
